...
export class VgmConverterCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: VgmConverterCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'VgmConverterCoreModule');
  }
}
